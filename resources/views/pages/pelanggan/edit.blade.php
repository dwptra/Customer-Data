        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-warning">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="quickForm" class="form-horizontal" action="{{ route('editCustomerProcess', $pelanggan->id) }}" method="post">
                        @csrf
                        @method('PATCH')
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="customer_name" class="form-control" id="customer_name" placeholder="Name" value="{{ $pelanggan->customer_name }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Email <span class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="{{ $pelanggan->email }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="phone" class="col-sm-2 col-form-label">Phone</label>
                                <div class="col-sm-10">
                                    <input type="number" name="phone" class="form-control" id="phone" placeholder="Phone" value="{{ $pelanggan->phone ? $pelanggan->phone : '' }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="address" class="col-sm-2 col-form-label">Address <span class="text-danger">*</span></label>
                                <div class="col-sm-10">
                                    <input type="text" name="address" class="form-control" id="address" placeholder="Address" value="{{ $pelanggan->address }}">
                                </div>
                            </div>
                        </div>
                        <!-- /.card-body -->
